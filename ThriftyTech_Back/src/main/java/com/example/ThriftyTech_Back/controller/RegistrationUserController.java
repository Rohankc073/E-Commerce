package com.example.ThriftyTech_Back.controller;// RegistrationUserController.java
import com.example.ThriftyTech_Back.controller.LoginRequest; // Replace with the actual package name
